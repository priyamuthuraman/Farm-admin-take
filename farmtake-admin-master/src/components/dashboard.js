...
import useGetDashboardQuery from "../react-query/useGetDashboardQuery";
...
const Dashboard = () => {
  const dashboard_data = useGetDashboardQuery();
        ...
        <Row>
              ...
              <CardBody className="bg-warning">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    <span className="m-0">Whole Sale</span>
                    <h3 className="mb-0">
                      <CountUp
                        className="counter"
                        end={
                          dashboard_data?.data?.dashboard_count
                            ?.whole_sale_total
                        }
                      />
            ...
            <Card className=" o-hidden  widget-cards">
              <CardBody className="bg-secondary ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    <span className="m-0">Retail sale</span>
                    <h3 className="mb-0">
                      <CountUp
                        className="counter"
                        end={
            ...
            <Card className="o-hidden widget-cards">
              <CardBody className="bg-primary">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    <span className="m-0">New Customer</span>
                    <h3 className="mb-0">
                      <CountUp
                        className="counter"
                        end={
              ...
              <CardBody className="bg-danger ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      $ <CountUp className="counter" end={12} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
          ...
          <Col xl="12 xl-100">
            <Card className="height-equal">
              ...
              <CardBody>
                <div className="user-status table-responsive">
                  <table className="table table-bordernone mb-0">
                    ...
                    <tbody>
                      {dashboard_data.data?.order?.map((order, index) => {
                        return (
                          <tr>
                            <td>{index + 1}</td>
                            <td className="digits">{order?.order_id}</td>
                            <td className="digits">
                              {order?.user?.first_name +
                                " " +
                                order?.user?.last_name}
                            </td>
                            <td className="digits">{order?.user?.emailid}</td>
                            <td className="digits">{order?.invoice_no}</td>
                            <td className="digits">
                            ...
                            <td className="digits">
                              {order?.payment?.generic_name}
                            </td>
                            <td className="font-primary">
                              {order?.delivery?.generic_name}
                            </td>
                          </tr>
                        );
                      })}
              ...
              <CardFooter className="card-view-all-button font-primary">
                <div
                  onClick={() => {
                    naviagte("/sales/orders");
                  }}
                >
                  View All
                </div>
